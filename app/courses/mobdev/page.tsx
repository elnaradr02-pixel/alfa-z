        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-5 lg:gap-6">
            {[
              ...
              { emoji: "👤", title: "1-на-1 с разработчиком", subtitle: "30 минут персональной mentor-сессии", desc: "В M8 (урок 47) — 30-минутный Discord-созвон 1-на-1 с действующим Mobile Developer из Kaspi.kz, inDriver, Halyk Bank или Яндекса. Персональный ревью резюме, LinkedIn и проектов. Это БОЛЬШАЯ ценность — обычно такие сессии стоят $50-100." },
            ].map((item, i) => (
