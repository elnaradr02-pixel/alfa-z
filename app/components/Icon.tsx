...
/**
 * Единый набор линейных иконок (24×24, stroke=currentColor) вместо эмодзи —
 * убирает «дешёвое» ощущение, задаёт консистентный нишевый стиль.
 * Стиль — тонкая обводка в духе lucide.
 */
